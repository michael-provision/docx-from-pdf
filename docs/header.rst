.. meta::
   :author: Artifex
   :description: pdf2docx is a Python library to extract data from PDF with pdfplumber/pdfminer, parse layout with rule, and generate docx file with python-docx
