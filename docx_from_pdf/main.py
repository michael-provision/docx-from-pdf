'''Entry for the ``docx-from-pdf`` command line.'''
import logging
from .converter import Converter


class DocxFromPdf:
    '''Command line interface for ``docx-from-pdf``.'''
    ...
    def convert(pdf_file:str,
        ...
        .. note::
            Refer to :py:meth:`~docx_from_pdf.converter.Converter.convert` for detailed description
            on above arguments.
        '''
    ...
    def gui():
        ...
        try:
            ...
            app = App(title='docx-from-pdf', width=500, height=600)
            app.mainloop()


parse = DocxFromPdf.convert


def main():
    '''Command line entry.'''
    import fire
    fire.Fire(DocxFromPdf)
